    ...
    <nav className="flex h-20 border-b font-medium justify-between bg-white">
      ...
      {session.data?.user ? (
        <div className="hidden lg:flex">
          <Button asChild variant={"secondary"} className="border-l border-t-0 border-b-0 border-r-0 rounded-none px-12 h-full bg-black text-white hover:bg-purple-400 hover:text-black transition-colors text-lg">
            <Link href={"/admin"}>
