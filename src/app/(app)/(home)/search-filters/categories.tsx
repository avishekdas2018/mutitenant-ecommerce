...
export const Categories = ({ data }: CategoriesProps) => {
  ...
  return (
    <div className="relative w-full">
      ...
      {/* View all items */}
      <div ref={containerRef} onMouseEnter={() => setAnyHovered(true)} onMouseLeave={() => setAnyHovered(false)} className="flex flex-nowrap items-center">
        ...
        <div className="shrink-0" ref={viewAllRef}>
          <Button onClick={() => setIsSidebarOpen(true)} variant={"elevated"} className={cn(
